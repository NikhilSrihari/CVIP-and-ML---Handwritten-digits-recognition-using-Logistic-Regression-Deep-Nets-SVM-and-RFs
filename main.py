...
def trainLogisticRegression(data):
	LRs = []
	hyperParams_set = [ {"Eta": 0.005, "epochs": 1, "batchSize": 100},
						{"Eta": 0.005, "epochs": 2, "batchSize": 100},
						{"Eta": 0.01, "epochs": 1, "batchSize": 100},
						{"Eta": 0.01, "epochs": 2, "batchSize": 100} ]
	#hyperParam_Eta_Values = [0.005, 0.01] #[0.005, 0.01, 0.05, 0.1, 0.2]
	#hyperParam_epochs_Values = [50000, 100000, 200000] #[10000, 25000, 50000, 100000, 200000]
	#hyperParam_batchSize_Values = [50000, 100000, 200000]
	i=0
...
def main():
	...
	LR_MNISTData_testing_y = testLogisticRegression(finalLRObject, MNISTData, "MNISTData")
